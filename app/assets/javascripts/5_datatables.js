...
//     } );
     ...
     */
    var oTable = $('#id_user_table').dataTable( {
    ...
    var oTable = $('#id_project_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
	               { "bSortable": false, "aTargets": [ 5 ] }],
	   "aaSorting": [],
    ...
    var oTable = $('#id_role_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
    ...
    var oTable = $('#id_department_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
	               { "bSortable": false, "aTargets": [ 2 ] }],
	   "aaSorting": [],
    ...
    var oTable = $('#id_client_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
    ...
    var oTable = $('#id_contact_point_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
	               { "bSortable": false, "aTargets": [ 3 ] }],
	   "aaSorting": [],
    ...
    var oTable = $('#id_access_right_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
	               { "bSortable": false, "aTargets": [ 3 ] }],
	   "aaSorting": [],
    ...
    var oTable = $('#id_fc_table').dataTable( {
	   "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
	   "aoColumnDefs": [
